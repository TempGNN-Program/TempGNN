...
`AE_APPENDIX_DRAFT.md` at the repository root. They cover the contribution and
artifact map, code download, environment and inputs, expected review time,
U280 latency reproduction, and figure generation from `results/result.csv`.
